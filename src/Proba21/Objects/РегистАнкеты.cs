...
namespace IIS.Proba21
{
    ...
    [View("РегистАнкетыE", new string[] {
            ...
            "ВакантДолжн.Должности as \'Вакантная должность\'"}, Hidden=new string[] {
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba21.ВакантДолжн fВакантДолжн;
        ...
        [PropertyStorage(new string[] {
                "ВакантДолжн"})]
        [NotNull()]
        public virtual IIS.Proba21.ВакантДолжн ВакантДолжн
        {
            get
            {
                ...
                IIS.Proba21.ВакантДолжн result = this.fВакантДолжн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba21.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba21.РегистАнкеты));
                }
            }
        }
    }
